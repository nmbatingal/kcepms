                    ...
                    <div class="navbar-custom-menu">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                   '. Html::a('<i class="fa fa-sign-out"></i>Log out', ['/site/logout'], ['data-method' => 'post', 'class' => 'btn btn-md btn-flat']) .'
                            </li>
        ...
        <!-- <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                        ...
                        if (!Yii::$app->user->isGuest) echo Html::a('<i class="fa fa-sign-out"></i>Log out', ['/site/logout'], ['data-method' => 'post', 'class' => 'btn btn-md btn-flat']);
