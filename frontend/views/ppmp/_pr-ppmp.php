                        ...
                        foreach ($query as $i => $item) {
                            ...
                            echo    '</td>
                                    ...
                                    <td class="col-8">';
                                        if ( $item['remaining'] == NULL ) {
                                            if ( $item['total_count'] != 0 ) {
                                                echo Html::button('<i class="fa fa-plus"></i>', ['class' => 'btn btn-sm btn-success btn-add-pr-item', 'data-id' => 'btn-row-'.$i]);
                                            }
                                        } elseif ( $item['remaining'] > 0 ) {
                                            echo Html::button('<i class="fa fa-plus"></i>', ['class' => 'btn btn-sm btn-success btn-add-pr-item', 'data-id' => 'btn-row-'.$i]);
                                        }
                        ...
                        foreach ($query as $i => $item) {
                            ...
                            echo '
                                <tr class="pr-item-list-'.$i.'">
                                    <td class="col-1">'.$no.'</td>
                                    <td class="col-2">'.
                                        Html::hiddenInput('unit', '', ['id' => 'unit-'.$i]).
                                        Html::hiddenInput('ppmp_id', $model['ppmp_id'], ['id' => 'ppmp_id-'.$i]).
                                        Html::hiddenInput('ppmp_item_id', $item['item_id'], ['id' => 'ppmp_item_id-'.$i]).
                                    '</td>
                                    <td class="col-3">';
                            ...
                            echo    '</td>
                                    <td class="col-6">'.
                                        ...
                                        Html::hiddenInput('price', $item['est_price'], ['id' => 'price-'.$i]).
                                    '</td>
                                    <td class="col-7">'.
                                        Html::input('number', 'total', '0.00', [
                                            'min'   => 0, 'step' => '0.01',
